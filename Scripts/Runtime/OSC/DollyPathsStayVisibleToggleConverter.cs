...
namespace VRCCamera
{
    public class DollyPathsStayVisibleToggleConverter : IOSCMessageConverter<bool>
    {
        ...
        {
            return new Message(OSCCameraEndpoints.DollyPathsStayVisible, new[] { new Argument(value) });
        }
    }
}
